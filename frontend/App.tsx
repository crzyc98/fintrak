      ...
      <main className="flex-1 overflow-y-auto pt-4 px-10 pb-16">
        <header className="flex justify-between items-center mb-8 h-16 shrink-0">
          ...
          <div className="flex items-center space-x-4">
             ...
             <button className="bg-[#3b82f6] hover:bg-[#2563eb] px-5 py-2 rounded-xl text-xs font-bold text-white transition-all shadow-lg shadow-blue-900/10">
        ...
        <div className="h-[calc(100vh-120px)]">
          ...
          {activeTab !== 'Dashboard' && activeTab !== 'Transactions' && activeTab !== 'Accounts' && activeTab !== 'Investments' && activeTab !== 'Categories' && activeTab !== 'Recurrings' && (
